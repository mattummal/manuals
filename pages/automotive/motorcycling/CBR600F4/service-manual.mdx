...
{/* ![Vehicle Identification Number](path/to/vehicle-identification-number-image.png) */}

#### Frame Serial Number

The frame serial number is stamped on the right side of the steering head.

{/* ![Frame Serial Number](path/to/frame-serial-number-image.png) */}

#### Engine Serial Number

The engine serial number is stamped on the rear side of the upper crankcase.

{/* ![Engine Serial Number](path/to/engine-serial-number-image.png) */}
...
{/* ![Carburetor Identification Number](path/to/carburetor-identification-number-image.png) */}
...
{/* ![Color Label](path/to/color-label-image.png) */}
...
{/* ![Fuel Lines](path/to/fuel-lines-image.png) */}
...
{/* ![Throttle Grip Free Play](path/to/throttle-grip-free-play-image.png) */}
...
{/* ![Lock Nut and Adjuster](path/to/lock-nut-adjuster-image.png) */}
...
{/* ![Lock Nut and Adjusting Nut](path/to/lock-nut-adjusting-nut-image.png) */}
...
{/* ![Choke Lever](path/to/choke-lever-image.png) */}
...
{/* ![Air Cleaner Housing Cover](path/to/air-cleaner-housing-cover-image.png) */}

Install the air cleaner element and cover, and tighten the screws.

Install the fuel tank (page 2-3).

{/* ![Air Cleaner Element](path/to/air-cleaner-element-image.png) */}
...
{/* ![Connectors and Radiator](path/to/connectors-radiator-image.png) */}
...
{/* ![Direct Ignition Coil](path/to/direct-ignition-coil-image.png) */}
{/* ![Spark Plug Diagram](path/to/spark-plug-diagram-image.png) */}
