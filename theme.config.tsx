...
const config: DocsThemeConfig = {
  useNextSeoProps() {
    ...
    if (route !== '/') {
      return {
        titleTemplate: '%s - manual.mattummal.com',
      }
    }
  },
  logo: (
  ...
  project: {
    link: 'https://github.com/mattummal/manuals',
  },
  chat: {
  ...
  docsRepositoryBase: 'https://github.com/mattummal/manuals/blob/main/',
  footer: {
    text: (
      <p>
  ...
  head: () => {
    ...
    return (
      <>
        {/* Open Graph */}
        <meta property="og:url" content={`https://manual.mattummal.com${asPath}`} />
        <meta property="og:title" content={frontMatter.title} />
        <meta property="og:type" content={'manual.mattummal.com'} />
        ...
        <meta name="twitter:site:domain" content="manual.mattummal.com" />
        <meta name="twitter:url" content={`https://manual.mattummal.com${asPath}`} />
        ...
        <script
          ...
          data-domains="manual.mattummal.com"
        />
      </>
    )
  },
...
function openGraph({
  ...
  logo = 'https://manual.mattummal.com/android-icon-192x192.png',
