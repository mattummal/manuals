![Cover Page](./img/cover-page.jpg)
# Honda CBR 600 F4 - Service Manual
...
## 1. General Information <a id="1-general-information"></a>
...
- [Tools](#tools)
- [Lubrication & Seal Points](#lubrication-seal-points)
- [Cable & Harness Routing](#cable-harness-routing)
- [Emission Control Systems](#emission-control-systems)
- [Emission Control Information Labels](#emission-control-information-labels)
...
![Carburetor Identification Number](./img/carburetor-identification-number-image.png)
...
![Color Label](./img/color-label-image.png)
...
![Cable & Harness Routing](./img/cable-harness-routing-1.png)
![Cable & Harness Routing](./img/cable-harness-routing-2.png)
![Cable & Harness Routing](./img/cable-harness-routing-3.png)
![Cable & Harness Routing](./img/cable-harness-routing-4.png)
![Cable & Harness Routing](./img/cable-harness-routing-5.png)
![Cable & Harness Routing](./img/cable-harness-routing-6.png)
![Cable & Harness Routing](./img/cable-harness-routing-7.png)
![Cable & Harness Routing](./img/cable-harness-routing-8.png)
![Cable & Harness Routing](./img/cable-harness-routing-9.png)
![Cable & Harness Routing](./img/cable-harness-routing-10.png)
![Cable & Harness Routing](./img/cable-harness-routing-11.png)
![Cable & Harness Routing](./img/cable-harness-routing-12.png)
![Cable & Harness Routing](./img/cable-harness-routing-13.png)
![Cable & Harness Routing](./img/cable-harness-routing-14.png)
![Cable & Harness Routing](./img/cable-harness-routing-15.png)
![Cable & Harness Routing](./img/cable-harness-routing-16.png)
![Cable & Harness Routing](./img/cable-harness-routing-17.png)
![Cable & Harness Routing](./img/cable-harness-routing-18.png)
![Cable & Harness Routing](./img/cable-harness-routing-19.png)
...
![Crankcase Emission Control System](./img/crankcase-emission-control-system-image.png)
...
![Exhaust Emission Control System](./img/exhaust-emission-control-system-image.png)
...
![Evaporative Emission Control System](./img/evaporative-emission-control-system-image.png)
...
![Emission Control Information Labels](./img/emission-control-information-labels-image-1.png)
![Emission Control Information Labels](./img/emission-control-information-labels-image-2.png)
![Emission Control Information Labels](./img/emission-control-information-labels-image-3.png)
...
## 2. Frame/Body Panels/Exhaust System <a id="2-frame-body-panels-exhaust-system"></a>
...
- [Front Inner Fairing](#front-inner-fairing)
- [Front Fairing](#front-fairing)
- [Windshield](#windshield)
- [Direct Air Intake Duct](#direct-air-intake-duct)
- [Exhaust System](#exhaust-system)
- [Rear Fender/Seat Rail](#rear-fender-seat-rail)
...
![Seat Installation](./img/seat-installation-image.png)
...
![Seat Cowl](./img/seat-cowl-image.png)
...
![Fuel Tank](./img/fuel-tank-image-1.png)
![Fuel Tank](./img/fuel-tank-image-2.png)
...
![Side Fairing](./img/side-fairing-image.png)
...
![Front Inner Fairing](./img/front-inner-fairing-image.png)
...
![Front Fairing](./img/front-fairing-image-1.png)

**Torque:** Fairing socket bolt: 2 N·m (0.2 kgf·m, 1.4 lbf·ft)

![Front Fairing](./img/front-fairing-image-2.png)
...
![Windshield](./img/windshield-image.png)
...
> Right duct: Remove the outer air vent hose (California: No. 8) from the duct by releasing the hose clip. 
> Left duct: Remove the wire harness from the duct.

Remove the air intake duct from the air duct grill of the front fairing and the front fairing stay. 

![Direct Air Intake Duct](./img/direct-air-intake-duct-image.png)
...
![Exhaust System](./img/exhaust-system-image.png)
...
![Rear Fender/Seat Rail](./img/rear-fender-seat-rail-image-1.png)

**Torque:** 
- Seat rail mounting: 49 N·m (5.0 kgf·m, 36 lbf·ft)
- Footpeg bracket: 26 N·m (2.7 kgf·m, 20 lbf·ft)

![Rear Fender/Seat Rail](./img/rear-fender-seat-rail-image-2.png)

Installation is in the reverse order of removal.

---

## 3. Maintenance <a id="3-maintenance"></a>

### Index

- [Service Information](#3-service-information)
- [Maintenance Schedule](#maintenance-schedule)
- [Fuel Line](#fuel-line)
- [Throttle Operation](#throttle-operation)
- [Carburetor Choke](#carburetor-choke)
...
- [Secondary Air Supply System](#secondary-air-supply-system)
- [Evaporative Emission Control System (California type only)](#evaporative-emission-control-system-california-type-only)
- [Drive Chain](#drive-chain)
- [Brake Fluid](#brake-fluid)
- [Brake Pads Wear](#brake-pads-wear)
...
- [Nuts, Bolts, Fasteners](#nuts-bolts-fasteners)
- [Wheels/Tires](#wheels-tires)
- [Steering Head Bearings](#steering-head-bearings)

---

### Service Information <a id="3-service-information"></a>
...
|---------------------------------|----------------------------------------------|
| Throttle grip free play         | 2–6 mm (1/16–1/4 in)                         |
| Spark plug                      | 49 state/Canada type: CR9EH-9 (NGK), U27FER-9 (DENSO) |
|                                | California type: CR9EHVX-9 (NGK)             |
| Spark plug gap                  | 0.80–0.90 mm (0.031–0.035 in)                |
| Valve clearance Intake          | 0.20 ± 0.03 mm (0.008 ± 0.001 in)            |
| Valve clearance Exhaust         | 0.28 ± 0.03 mm (0.011 ± 0.001 in)            |
| Recommended engine oil          | Honda GN4 4-stroke oil or equivalent motor oil |
|                                | API service classification: SF or SG         |
|                                | Viscosity: SAE 10W-40                        |
| Engine oil capacity After draining | 3.0 L (3.2 US qt, 2.6 Imp qt)            |
| Engine oil capacity After draining/filter change | 3.3 L (3.5 US qt, 2.9 Imp qt) |
| Engine oil capacity After disassembly | 3.7 L (3.9 US qt, 3.3 Imp qt)         |
| Carburetor vacuum difference (base carburetor: No. 4) | Within 30 mm Hg (1.2 in Hg) |
| Engine idle speed               | 49 state/Canada type: 1,300 ± 100 rpm        |
|                                | California type: 1,400 ± 100 rpm             |
| Drive chain slack               | 25–35 mm (1–1 3/8 in)                        |
| Recommended brake fluid         | DOT 4                                        |
| Clutch lever free play          | 10–20 mm (3/8–13/16 in)                      |
| Cold tire pressure Up to 90 kg (200 lbs) load | Front: 250 kPa (2.50 kgf/cm², 36 psi) |
|                                | Rear: 290 kPa (2.90 kgf/cm², 42 psi)         |
| Cold tire pressure Up to maximum weight capacity | Front: 250 kPa (2.50 kgf/cm², 36 psi) |
|                                | Rear: 290 kPa (2.90 kgf/cm², 42 psi)         |
| Tire size Front                 | 120/70 ZR17 (58W)                            |
| Tire size Rear                  | 180/55 ZR17 (73W)                            |
| Tire brand Front                | BRIDGESTONE BT56F RADIAL E, DUNLOP D207FJ, MICHELIN TX15C |
| Tire brand Rear                 | BRIDGESTONE BT56R RADIAL G, DUNLOP D207P, MICHELIN TX25 |
...
![Maintenance Schedule Table](./img/maintenance-schedule-table.png)
...
![Fuel Lines](./img/fuel-lines-image.png)
...
![Throttle Grip Free Play](./img/throttle-grip-free-play-image-1.png)
...
![Throttle Grip Free Play](./img/throttle-grip-free-play-image-2.png)
...
![Lock Nut and Adjusting Nut](./img/lock-nut-adjuster-image.png)

Raise the fuel tank and support it.
Loosen the lock nut, turn the adjusting nut as required and tighten the lock nut.
...
![Choke Lever](./img/choke-lever-image.png)
...
Remove the ten cover screws and the air cleaner housing cover.
Replace the element in accordance with the maintenance schedule or any time it is excessively dirty or damaged.

![Air Cleaner Housing Cover](./img/air-cleaner-housing-cover-image.png)

Install the air cleaner element and cover, and tighten the screws.

Install the fuel tank.

![Air Cleaner Element](./img/air-cleaner-element-image.png)
...
Disconnect the fan motor switch 2P (Black) connector.
Disconnect the horn connectors. Remove the horn bolt and horn.
Remove the radiator mounting bolts, washers and nut.

Cover the radiator with a shop towel to avoid damaging the radiator fins.
Swing the radiator forward so that the lower mounting stay is not interfered with the radiator. Slide the radiator to the right to remove it off the boss of the frame.
Move the radiator down without disconnecting the water hoses and secure it to the fork legs.

![Connectors and Radiator](./img/connectors-radiator-image.png)

Disconnect the ignition coil 2P connectors and remove the direct ignition coils.
Clean around the spark plug bases.
...
**Recommended Spark Plug:** CR9EH-9 (NGK)
                            U27FER-9 (DENSO)

![Direct Ignition Coil](./img/direct-ignition-coil-image.png)
![Spark Plug Diagram](./img/spark-plug-diagram-image.png)
...
![Spark Plug Gap](./img/spark-plug-gap-image.png)
...
![Center Electrode Diagram](./img/center-electrode-image.png)
...
![Rounded Electrode Diagram](./img/rounded-electrode-image.png)
...
![Wire Type Feeler Gauge Diagram](./img/wire-type-feeler-gauge-image.png)
...
![Spark Plug Installation](./img/spark-plug-installation-image.png)
...
![Valve Clearance Inspection](./img/valve-clearance-inspection-image.png)

![Cam Sprockets Diagram](./img/cam-sprockets-diagram-image.png)
...
![Feeler Gauge Usage](./img/feeler-gauge-usage-image.png)
...
![Punch Mark Alignment](./img/punch-mark-alignment-image.png)
...
![T Mark Alignment](./img/t-mark-alignment-image.png)
...
![Punch Mark Alignment](./img/punch-mark-alignment-image-2.png)
...
![Valve Lifter Cleaning](./img/valve-lifter-cleaning-image.png)
...
![Shim Measurement](./img/shim-measurement-image-1.png)
...
![Shim Measurement](./img/shim-measurement-image-2.png)
...
![Shim Installation](./img/shim-installation-image.png)
...
![Timing Hole Cap Installation](./img/timing-hole-cap-installation-image.png)
...
![Oil Level Inspection](./img/oil-level-inspection-image.png)
...
![Oil Filler Cap](./img/oil-filler-cap-image.png)
...
![Oil Viscosity Chart](./img/oil-viscosity-chart-image.png)
...
![Oil Drain Bolt](./img/oil-drain-bolt-image.png)

![Oil Filter Wrench](./img/oil-filter-wrench-image.png)

![O-Ring Application](./img/o-ring-application-image.png)
...
![Vacuum Tubes](./img/vacuum-tubes-image.png)

![Vacuum Gauges](./img/vacuum-gauges-image.png)

![Throttle Stop Screw](./img/throttle-stop-screw-image.png)

![Synchronization Adjusting Screw](./img/synchronization-adjusting-screw-image.png)
...
![Radiator Coolant Level](./img/radiator-coolant-level-image.png)

![Reserve Tank Cap](./img/reserve-tank-cap-image.png)
...
![Water Hoses](./img/water-hoses-image.png)
...
![Air Supply Hoses](./img/air-supply-hoses-image.png)
![PAIR Check Valve](./img/pair-check-valve-image.png)
